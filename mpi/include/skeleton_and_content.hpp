...
#include <detail/forward_skeleton_iarchive.hpp>
#include <detail/forward_skeleton_oarchive.hpp>
#include <detail/ignore_iprimitive.hpp>
#include <detail/ignore_oprimitive.hpp>
...
#include <detail/content_oarchive.hpp>
...
#  include <detail/broadcast_sc.hpp>
#endif

#ifdef BOOST_MPI_COMMUNICATOR_HPP
#  include <detail/communicator_sc.hpp>
#endif
