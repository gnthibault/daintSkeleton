...
#  include <collectives/all_gather.hpp>
#  include <collectives/all_reduce.hpp>
#  include <collectives/all_to_all.hpp>
#  include <collectives/broadcast.hpp>
#  include <collectives/gather.hpp>
#  include <collectives/gatherv.hpp>
#  include <collectives/scatter.hpp>
#  include <collectives/scatterv.hpp>
